...
def serialize_movie_data(movie, info):
    """to serialize one dictionary item (key/value) to the correct string format for website generation. This accesses
    the title,    the year, and poster url and formats them into appropriate html and accessing the CSS classes
